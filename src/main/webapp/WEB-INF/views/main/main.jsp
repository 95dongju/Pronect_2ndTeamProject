			...
			<nav id="nav">
				<ul>
					<c:if test="${not empty member }">
						<li><a href="${conPath}/group/groupList.do?mid=${member.mid}&pageNum=1"><i class="fa-solid fa-list fa-shake"></i> 전체</a></li>
						<li><a href="${conPath}/group/studyList.do?mid=${member.mid}&pageNum=1"><i class="fa-solid fa-graduation-cap fa-beat" style="--fa-animation-duration: 2s; --fa-beat-scale: 2.0;"></i> &nbsp; 스터디</a></li>
						<li><a href="${conPath}/group/projectList.do?mid=${member.mid}&pageNum=1"><i class="fa-solid fa-briefcase fa-beat" style="--fa-animation-duration: 2s; --fa-beat-scale: 2.0;"></i> &nbsp; 프로젝트</a></li>
						<li style="float:right; margin-right:70px;"><a href="${conPath}/group/register.do"><i class="fa-solid fa-square-plus fa-beat" style="--fa-animation-duration: 2s; --fa-beat-scale: 2.0;"></i> &nbsp; 새 글 쓰기</a></li>
					</c:if>
					<c:if test="${empty member }">
						<li><a href="${conPath}/group/groupList.do?pageNum=1"><i class="fa-solid fa-list fa-shake"></i> 전체</a></li>
						<li><a href="${conPath}/group/studyList.do?pageNum=1"><i class="fa-solid fa-graduation-cap fa-beat" style="--fa-animation-duration: 2s; --fa-beat-scale: 2.0;"></i> &nbsp; 스터디</a></li>
						<li><a href="${conPath}/group/projectList.do?pageNum=1"><i class="fa-solid fa-briefcase fa-beat" style="--fa-animation-duration: 2s; --fa-beat-scale: 2.0;"></i> &nbsp; 프로젝트</a></li>
					</c:if>
				</ul>
